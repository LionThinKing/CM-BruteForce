...
enum{ID_SINICIO,ID_INICIO, ID_SMAXIMO,ID_MAXIMO,ID_SURL,ID_URL};
...
LRESULT CALLBACK WindowProcedure (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
  ...
  HDC hdc;
    ...
    switch (message)                  /* handle the messages */
    {
        ...
        case WM_CREATE:
            CreateWindowEx(0,"STATIC", "# de Caracteres", WS_VISIBLE | WS_CHILD, 10, 10, 120, 15,hwnd, (HMENU)(ID_SINICIO), NULL, NULL);
